...
| 📊 数据分析 | 后端实时聚合 **7 个统计维度**：年龄段分布、疾病类型 Top6、男女患病占比、科室分布、热门医院、各疾病平均身高体重、高频关键词 |
| 📈 可视化大屏 | Vue 2 + ECharts 5.4 + data-view + echarts-wordcloud，集成玫瑰图、环形图、词云、水球图、柱状图、KPI 指标卡、病例滚动列表 |
